...
import { filterProductsAction } from "@/app/actions"
...
interface ParaProductListingProps {
    initialProducts?: Product[]
    initialTotal?: number
    initialTotalPages?: number
}

export function ParaProductListingContent({
    initialProducts = [],
    initialTotal = 0,
    initialTotalPages = 1
}: ParaProductListingProps) {
    ...
    const fetchProducts = useCallback(async () => {
        ...
        try {
            ...
            const data = await filterProductsAction("para", params.toString())
...
export function ParaProductListing({ initialProducts, initialTotal, initialTotalPages }: ParaProductListingProps) {
    return (
        <Suspense fallback={
