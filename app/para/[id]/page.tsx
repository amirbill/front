...
async function getProduct(id: string): Promise<Product | null> {
    try {
        const res = await fetch(`${API_URL}/para/${encodeURIComponent(id)}`, {
            cache: 'no-store'
        })
...
export default async function ParaProductDetailPage({
    params,
}: {
        ...
        return (
            <main className="min-h-screen bg-background">
                ...
                <div className="mx-auto max-w-6xl px-4 py-16 text-center">
                    ...
                    <Link
                        href="/para"
                        className="mt-4 inline-block px-6 py-2 bg-teal-600 text-white rounded-full font-medium hover:bg-teal-700"
                    >
    ...
    return (
        <main className="min-h-screen bg-background">
            ...
            <div className="mx-auto max-w-6xl px-4 py-8">
                ...
                <nav className="text-sm text-muted-foreground mb-6">
                    ...
                    {product.topCategory && (
                        <>
                            <span className="mx-2">/</span>
                            <Link
                                href={`/para?category=${encodeURIComponent(product.topCategory)}&type=top`}
                ...
                <ProductHero product={product} accentColor="teal" />
